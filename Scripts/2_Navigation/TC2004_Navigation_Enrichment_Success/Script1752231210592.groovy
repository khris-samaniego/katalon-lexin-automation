...
WebUI.click(findTestObject('2_Navigation/Nav_Button_MaterialGroup_Enrichment'))

WebUI.waitForElementVisible(findTestObject('Object Repository/2_Navigation/Nav_Breadcrumb_Enrichment'), 10)

WebUI.verifyElementPresent(findTestObject('Object Repository/2_Navigation/Nav_Breadcrumb_Enrichment'), 10)

...
WebUI.verifyElementPresent(findTestObject('Object Repository/3_Search/Search_Breadcrumb_Search'), 10)

WebUI.click(findTestObject('Object Repository/2_Navigation/Nav_Button_Dashboard'))

WebUI.waitForElementVisible(findTestObject('2_Navigation/Nav_Breadcrumb_Dashboard'), 10)

WebUI.verifyElementPresent(findTestObject('2_Navigation/Nav_Breadcrumb_Dashboard'), 10)

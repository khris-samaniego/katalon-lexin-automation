...
'Click Sign In button without any input'
WebUI.click(findTestObject('Object Repository/1_Security and Login/Login_Button_Sign in'))

WebUI.waitForElementVisible(findTestObject('1_Security and Login/Login_Button_Sign in'), 10)

'Verify user is still in the login page'
WebUI.verifyElementVisible(findTestObject('1_Security and Login/Login_Button_Sign in'))
